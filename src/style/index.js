...
export const loading = {
  width: '70px',
  height: '48px',
  staticImg: '//static.kaiyanapp.com/eyepetizer-web/assets/images/detail/loading_out@3x.444b89a3.png',
  rotateImg: '//static.kaiyanapp.com/eyepetizer-web/assets/images/detail/loading_in@3x.94a9c4b4.png'
}
